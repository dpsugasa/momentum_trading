...
from StarScream.StarScream import StarScream
from StarScream.Indicators import Indicators
...
is_msft_porfitable = trading_robot.portfolio.is_profitable(
    symbol="MSFT US Equity",
    current_price=current_quotes.loc['MSFT US Equity']['PX LAST']
)
